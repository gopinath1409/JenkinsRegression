...
public void book(String firstname, String lastname, String billingaddress, String creditcardno, String creditcardtype, String expirydateMonth, String expirydateyear, String cvvnumber) {
	type(getTxtFirstname(), firstname);
	type(getTxtLastname(), lastname);
	type(getTxtaddress(), billingaddress);
	type(getTxtCreditcard(), creditcardno);
	type(getDropdown1(), creditcardtype);
	type(getDropdown2(), expirydateMonth);
	type(getDropdown3(), expirydateyear);
	type(getTxtccv(), cvvnumber);
	btnClick(getBtnBook());
