...
public class LoginPageStep extends LibGlobal {
  ...
  public void user_should_verify_msg() {
	...
	@When("User should Search the Hotels {string} , {string} , {string}, {string}, {string},{string}")
	public void user_should_Search_the_Hotels(String location, String hotels, String RoomType, String noofRooms, String adultsperRoom, String childrenperRoom) {
		
		searchpage = pageObjectManager.getSearchPage();
		searchpage.search(location,hotels,RoomType,noofRooms,adultsperRoom,childrenperRoom);
	...
	public void user_should_Select_the_Radio_button() {
		selectpage = pageObjectManager.getSelectPage();
		selectpage.select();
	...
	public void user_should_enter(String firstname, String lastname, String billingaddress, String creditcardno, String creditcardtype, String expirydateMonth, String expirydateyear, String cvvnumber) {
		bookpage = pageObjectManager.getBookPage();
		bookpage.book(firstname, lastname, billingaddress, creditcardno, creditcardtype, expirydateMonth, expirydateyear, cvvnumber);
